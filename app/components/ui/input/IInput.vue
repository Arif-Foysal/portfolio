...
<template>
  <div
    ...
    :class="cn('group/input rounded-lg p-[2px] transition duration-300 bg-linear-to-r hover:from-blue-500/50 hover:via-purple-500/50 hover:to-pink-500/50', props.containerClass)"
    :style="{
      background: visible ? containerBg : 'transparent',
    }"
