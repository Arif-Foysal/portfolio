<template>
  <header class=" backdrop-blur border-b border-gray-200 dark:border-gray-800 h-16 sticky top-0 z-50 transition-colors// Nuxt Color Mode + Tailwind (no manual DOM/localStorage)
  ...
  colorMode.preference = colorMode.preference === 'dark' ? 'light' : 'dark';
    ...
    <div class="flex items-center justify-between gap-3 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-end lg:flex-1 gap-1.5">
        ...
        >
          <slot name="toggle">
            <svg :class="['h-6 w-6', { 'hidden': isMenuOpen }]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
